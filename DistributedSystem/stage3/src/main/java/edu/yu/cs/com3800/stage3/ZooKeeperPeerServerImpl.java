...
public class ZooKeeperPeerServerImpl extends Thread implements ZooKeeperPeerServer{
    ...
    public ZooKeeperPeerServerImpl(int myPort, long peerEpoch, Long id, Map<Long,InetSocketAddress> peerIDtoAddress){
        ...
        try {
            ...
            this.jrf = new JavaRunnerFollower(myPort,myAddress,outgoingMessages,incomingMessages);
            this.robinHood = new RoundRobinLeader(myPort,id,myAddress,outgoingMessages,incomingMessages,peerIDtoAddress);
        } catch (IOException e) {
